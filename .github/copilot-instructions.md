...
Compact Public Suffix List (PSL) implementation for Rust. 32KB embedded JSON trie compressed with zstd. O(depth) lookup. Auto-updated monthly from publicsuffix.org.
